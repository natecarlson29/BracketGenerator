...
<html>
    <head>
        ...
        <title>Brackets - Player Profile</title>
    </head>
    <body>
        <header>
...
?>
            ...
            <div class='wrapper1'>
                <h1><?php echo($playerClicked . '\'s Profile') ?></h1>
                <table>
                    <tr>
                        <th>Tournament Name</th>
                        <th>Placing</th>
                    </tr>
                    <?php foreach($tournamentIDsArray as $key=>$value){echo('<tr><td>' . $value . '</td><td>' . $placingsArray[$key] . '</td></tr>');} ?>
                </table>
            </div>
